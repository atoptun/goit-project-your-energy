import{r as e}from"./rolldown-runtime-DMWpINJ5.js";import{n as t,t as n}from"./vendor-BMtsypGf.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function r(e){return e.split(`/`).pop()||`index.html`}function i(){let e=r(window.location.pathname);document.querySelectorAll(`.header-nav-link`).forEach(t=>{r(t.pathname)===e&&t.classList.add(`is-active`)})}t.defaults.baseURL=`https://your-energy.b.goit.study/api`;async function a(e={}){let{data:n}=await t.get(`/filters`,{params:e});return n}async function o(e={}){let{data:n}=await t.get(`/exercises`,{params:e});return n}async function s(e){let{data:n}=await t.get(`/exercises/${e}`);return n}async function c(){let{data:e}=await t.get(`/quote`);return e}var l=e(n(),1);l.default.settings({timeout:5e3,resetOnHover:!0,icon:`material-icons`,transitionIn:`flipInX`,transitionOut:`flipOutX`,position:`topRight`});function u(e){l.default.error({title:`Error`,message:e})}function d(e,t=!1){let n=t?`
  ...
  `}var p=`dailyQuote`;function m(){return new Date().toLocaleDateString(`en-CA`)}function h(){let e=localStorage.getItem(p);if(!e)return null;try{let t=JSON.parse(e);return t.date===m()?t:(localStorage.removeItem(p),null)}catch{return localStorage.removeItem(p),null}}function g(e){let t={...e,date:m()};localStorage.setItem(p,JSON.stringify(t))}async function _(){let e=h();if(e)return e;let t=await c();return g(t),t}function v({quote:e,author:t}){let n=document.querySelector(`[data-quote-text]`),r=document.querySelector(`[data-quote-author]`);!n||!r||(n.textContent=e,r.textContent=t)}async function y(){if(document.querySelector(`[data-quote-text]`))try{v(await _())}catch{v({quote:`The body achieves what the mind believes.`,author:`Unknown`})}}function b(){let e={openBtn:document.querySelector(`.js-mobile-menu-btn`),closeBtn:document.querySelector(`.js-mobile-menu-close-btn`),menu:document.querySelector(`.js-mobile-menu`)};e.openBtn?.addEventListener(`click`,t),e.closeBtn?.addEventListener(`click`,t);function t(){e.menu?.classList.toggle(`is-open`),document.body.classList.toggle(`is-menu-open`)}x()}function x(){function e(e){if(e.matches){document.body.classList.remove(`is-menu-open`);let e=document.querySelector(`.js-mobile-menu`);e&&e.classList.remove(`is-open`)}}let t=window.matchMedia(`(min-width: 768px)`);t.addEventListener(`change`,e),e(t)}export{u as a,a as c,d as i,i as l,y as n,s as o,f as r,o as s,b as t};
//# sourceMappingURL=mobile-menu-BOR1fsA5.js.map